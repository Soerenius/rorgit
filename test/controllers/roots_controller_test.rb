...
class RootsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create root" do
    assert_difference('Root.count') do
      post roots_url, params: { root: { description: @root.description, guid: @root.guid, name: @root.name, versionDate: @root.versionDate, versionId: @root.versionId } }
    end
  ...
  test "should update root" do
    patch root_url(@root), params: { root: { description: @root.description, guid: @root.guid, name: @root.name, versionDate: @root.versionDate, versionId: @root.versionId } }
